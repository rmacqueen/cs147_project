class LoadData < ActiveRecord::Migration
  def up
    ...
    day1 = Content.new(:date_time => "2009-08-30 10:44:23", 
        :value => "Flight Day", :trip_id => 1, :content_type => "milestone")
    day1.save()

  	photo1 = Content.new(:date_time => "2009-08-30 10:44:23",
        :value => "ouster.jpg", :trip_id => 1, :content_type => "image")
    ...
    photo2 = Content.new(:date_time => "2010-09-13 20:00:00",
        :value => "bieber1.jpg", :trip_id => 1, :content_type => "image")
    ...
    photo3 = Content.new(:date_time => "2010-09-13 20:05:03",
        :value => "bieber2.jpg", :trip_id => 1, :content_type => "image")
    ...
    day2 = Content.new(:date_time => "2009-08-30 10:44:23", 
        :value => "Beach Day", :trip_id => 1, :content_type => "milestone")
    day2.save()

    photo4 = Content.new(:date_time => "2009-11-18 18:02:00",
        :value => "hilton1.jpg", :trip_id => 1, :content_type => "image")
    ...
    photo5 = Content.new(:date_time => "2009-09-20 17:30:00",
        :value => "hilton2.jpg", :trip_id => 1, :content_type => "image")
    ...
    photo6 = Content.new(:date_time => "2009-07-10 16:02:49",
        :value => "obama1.jpg", :trip_id => 1, :content_type => "image")
    ...
    day3 = Content.new(:date_time => "2009-08-30 10:44:23", 
        :value => "Party Day", :trip_id => 1, :content_type => "milestone")
    day3.save()


    photo7 = Content.new(:date_time => "2010-03-18 23:48:00",
        :value => "obama2.jpg", :trip_id => 1, :content_type => "image")
    ...
    photo8 = Content.new(:date_time => "2010-08-30 14:26:00",
        :value => "obama3.jpg", :trip_id => 1, :content_type => "image")
    ...
    photo9 = Content.new(:date_time => "2010-09-04 09:16:32",
        :value => "santa1.jpg", :trip_id => 1, :content_type => "image")
